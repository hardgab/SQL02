...
IF @quantidade <= 0 
	BEGIN
		PRINT 'Error: Quantidade invalida para o pedido';
...
ELSE 
	BEGIN 
	PRINT 'Pedido válido: Relaizando a inserção na tabela....'
	SET @status_pedido = 'Pendente';

		INSERT INTO pedidos (pedido_id, cliente_id,produto_id, quantidade, valor_total, Data_pedido, status_pedido) VALUES
		(NEXT VALUE FOR seq_pedido_id, @cliente_id, @produto_id, @quantidade, @valor_total, GETDATE (), @status_pedido)
END
